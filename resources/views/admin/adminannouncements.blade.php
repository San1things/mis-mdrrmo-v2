                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item border border-start-0">
                                <a class="nav-link"
                                    href="?type=Seminar&searchAnnouncement={{ $qstring['searchAnnouncement'] }}"
                                    style="{{ request('type') === 'Seminar' ? 'font-weight: 700;' : '' }}">Seminars</a>
                            </li>
                            <li class="nav-item border border-start-0">
                                <a class="nav-link"
                                    href="?type=Event&searchAnnouncement={{ $qstring['searchAnnouncement'] }}"
                                    style="{{ request('type') === 'Event' ? 'font-weight: 700;' : '' }}">Events</a>
                            </li>
                            <li class="nav-item border border-start-0">
                                <a class="nav-link"
                                    href="?type=other&searchAnnouncement={{ $qstring['searchAnnouncement'] }}"
                                    style="{{ request('type') === 'other' ? 'font-weight: 700;' : '' }}">Other</a>
                            </li>
                        </ul>
                        <form class="d-flex" role="search" method="get">
                            ...
                            <input class="form-control me-3 fs-4" name="searchAnnouncement" type="search" value=""
                                aria-label="Search" placeholder="Search name...">
